...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 30, 2021 at 06:41 AM
...
INSERT INTO `claim_case` (`claimID`, `admitDate`, `dischargeDate`, `icuFromDate`, `icuToDate`, `payableAmount`, `healthCondition`, `doctorComment`, `custFeedback`, `overPaid`, `custID`, `doctorID`, `medScruID`, `dataEntryOfficerID`, `FieldAgID`, `hospitalID`, `policyID`, `caseStatus`) VALUES
(1, '2020-07-01', '2020-08-08', '2020-08-08', '2020-08-08', NULL, 'Dengue Fever', 'Normal', NULL, 0, 7, 5, 2, 1, 4, 1, 1, 'Doctor confirmed'),
(2, '2020-10-09', '2020-10-08', '2020-10-12', '2020-10-12', 0, 'Fracture in leg', NULL, 'Disappointed', 1, 1, NULL, 3, 1, 4, 1, 1, 'Rejected'),
(6, '2020-09-10', '2020-09-19', '2020-09-14', '2020-09-16', NULL, 'DIABETES MELLITUS', NULL, NULL, 0, 1, 5, 3, 1, 7, 1, 1, 'Doctor pending'),
(10, '2020-09-12', '2020-09-27', '2020-09-27', '2020-09-27', 0, 'BENIGN ESSENTIAL', NULL, NULL, 0, 1, 5, 2, 1, 4, 1, 1, 'Rejected'),
(12, '2020-10-14', '2020-10-14', '2020-10-14', '2020-10-14', NULL, 'Hyperglycemic Symptoms ', NULL, NULL, 0, 1, NULL, 2, 1, 7, 1, 1, 'Initial'),
(13, '2020-10-14', '2020-10-14', '2020-10-14', '2020-10-14', 50000, 'BENIGN ESSENTIAL', NULL, 'Kind Service', 1, 1, NULL, 3, 1, 4, 4, 1, 'Completed'),
(15, '2020-11-14', '2020-11-19', '2020-11-12', '2020-11-12', 32000, 'HYPERTENSION', NULL, 'Satisfied', 0, 1, NULL, 3, 1, 7, 1, 1, 'Completed'),
(18, '2020-11-13', '2020-11-14', NULL, NULL, NULL, 'Neuroglycopenic Symptoms ', NULL, NULL, 0, 14, NULL, 2, 1, 7, 1, 1, 'Initial'),
(19, '2020-11-13', '2020-11-28', '2020-11-28', '2020-11-28', NULL, 'DIABETES MELLITUS', NULL, NULL, 0, 14, NULL, 2, 1, 4, 1, 1, 'Documents updated'),
(23, '2020-11-12', '2020-11-06', '2020-11-21', '2020-11-21', NULL, 'Hyperglycemic Symptoms', NULL, NULL, 0, 1, NULL, 3, 1, 7, 1, 1, 'Initial'),
(24, '2020-12-18', '2020-12-30', NULL, NULL, NULL, 'DEPRESSION', NULL, NULL, 0, 1, NULL, 2, 1, 4, 1, 1, 'Initial'),
(25, '2021-03-22', '2021-03-23', NULL, NULL, NULL, 'Fevers', NULL, NULL, 0, 20, NULL, 2, 10, 4, 1, 2, 'Initial'),
(26, '2021-03-22', '2021-03-23', NULL, NULL, NULL, 'Hypertension', NULL, NULL, 0, 14, NULL, 2, 10, 4, 1, 1, 'Initial'),
(27, '2021-03-27', '2021-03-02', NULL, NULL, 10000, 'DEPRESSION', NULL, 'Much Satisfied', 0, 15, NULL, 15, 1, 4, 1, 1, 'Completed');
...
(11, 'Steel Carter', '4z6', '$2y$11$F/8XJP.si.s5Qpf5n4gFEeZfAghS9N75cVTu2Vwnxycu3P2mcPAtG', 'Ap #996-9701 Quis Ave3', '123123919V', '1988-04-01', 'sem@acnullaIn.edua', 'm', 1, 1),
...
(20, 'Griffin Houston', 'Izs', '$2y$11$C02wMmgSnZjJYp8Rda/O9.m/eGkd7IaUP3VesWpB7.Iao7OIMqAfC', '111-6854 Ut St.', '123191999V', '1970-11-20', 'georgeraveen@gmail.com', 'o', 2, 1),
...
(26, 'Hyatt Hurst', 'S7K', '$2y$11$lPEdavataJMowNDV3O9L7e1ylUE86hIY3UupoBfUyJqffSdSNvjeu', 'P.O. Box 426, 6843 Vivamus Av.', '651021999V', '1976-07-29', 'eu@fames.ca', 'm', 2, 1),
...
(32, 'removed', 'Til', '$2y$11$0eSQkLon17F6FgV3.RJal.LwVCnT3uC8dlCfisQ1r4sfMesB9l55W', 'removed', 'removed', '2020-07-01', 'removed', 'o', 1, 0);
...
(32, '2021-03-29', 'Regular', '2021-03-29', 'Active');
...
INSERT INTO `data_entry` (`empID`, `type`) VALUES
(1, 'Executive'),
(10, 'Trainee');
...
INSERT INTO `doctor` (`empID`, `specialization`) VALUES
(5, 'Neurologist'),
(8, 'Orthopedic'),
(19, 'Psychiatrists');
...
(6, 'asd', '$2y$11$5lngklDjotWxydvMeD44E.uGqE.O8jK0cOaaP7da1Cmnm/YmqZ/bu', 'Sisil', 'Perera', 'm', '2020-08-04', '1231231456', 'Street', 'georgeraveen@gmail.com', 'MGR', 1),
...
(14, 'Z8A', '$2y$11$iApJmmF93UOtS1F9ZcRSAOcw2s0PmRLZ4z42ebqIb3HJy2W.EDDsW', 'Ferdinand', 'Bright', 'm', '2021-03-29', '9876587656', '4957 Egestas Rd.', 'georgeraveen@hotmail.com', 'FAG', 1),
(15, 'FR3', '$2y$11$GI0K7x4IS56J1m/Cx.ULpuS5OUy8DagJXHnEh/LqcW/xqlQj/IWI.', 'Jerdinanh', 'Tright', 'f', '1996-01-30', '234564765', '57 Eagestas Rd.', 'grisus.Nulla@ut.z', 'MED', 1),
(19, 'QBW', '$2y$11$f0X6zeiAzZXXBxkdCJlfzu.OExbwdbxNEaVUhqAgmHXsSUvs135Cq', 'Verdinand', 'Brian', 'm', '1996-03-30', '987237232', '986 Eagestas Rd.', 'dgeorgeraveen@hotmail.com', 'DOC', 1);
...
CREATE TABLE IF NOT EXISTS `employee_contact` (
  ...
  `empContactNo` bigint(11) NOT NULL,
...
--
-- Dumping data for table `field_agt`
--

INSERT INTO `field_agt` (`empID`, `area`) VALUES
(4, 'Colombo 1'),
(7, 'Colombo 2'),
(14, 'Colombo 7');
...
INSERT INTO `insurance_policy` (`policyID`, `documentDIR`, `date`, `remarks`, `vPremium`, `rPremium`, `status`) VALUES
(1, 'policy/', '2020-08-05', 'Amet venenatis urna cursus eget nunc.', 1000, 800, 1),
(2, '', '2020-11-10', 'suspendisse. Vel elit scelerisque mauris pellentesque pulvinar pellentesque', 1100, 900, 1),
(3, NULL, '2021-03-12', 'sdsf', 22, 12, 0);
...
(14, 20, '2021-03-12', 'Congenital', 'Heart attack', 'Minor symptoms'),
(15, 1, '2021-03-10', 'Congenital', 'Fever', 'mild'),
(16, 1, '2021-03-10', 'Congenital', 'Fever', 'mild');
...
--
-- Dumping data for table `over_paid`
--

INSERT INTO `over_paid` (`claimID`, `overPaidAmount`, `remark`) VALUES
(2, 123, 'mistakes'),
(13, 3432, 'mistake');
