...
class Employee extends Models{
    ...
    public function updateStatus($_id){
        ...
        $stmt= $this->conn->prepare("update $this->table set status= 0,hashPass='removed',empFirstName='removed',empLastName='removed',empNIC='removed',empAddress='removed',email='removed'
                                                            where empID = $_id ") ;   
        $stmt->execute();                                                  
